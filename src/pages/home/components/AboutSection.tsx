    ...
    <section id="about" className=" bg-kh-dark relative overflow-hidden">
      <div className="max-w-[1920px] w-full mx-auto px-6 lg:px-12">
        <div className="flex flex-col lg:flex-row  items-center justify-center gap-15">
          {/* Left - Image */}
          <div className="w-full lg:w-2/3 relative flex justify-end">
            {/* Blue accent line */}
            ...
            <div className="relative z-10 w-full lg:w-full max-w-[400px] aspect-3/4 rounded overflow-hidden">
              <img
                src={aboutImg}
                alt="About Kennedi"
          ...
          <div className=" flex flex-col gap-6">
            ...
            <div className="pt-4 border-t border-white/5 mt-2">
              <Button
                variant="kh-outline"
                className="inline-flex items-center gap-2 font-condensed font-bold tracking-widest text-kh-blue border-kh-blue hover:text-kh-blue-light transition-colors uppercase text-sm group"
              >
