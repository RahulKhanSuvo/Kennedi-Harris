...
import scheduleHeroPlayer from "../../../assets/highlight-main.png";
      ...
      <Container className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col gap-6 animate-fade-in-up">
          ...
          <h1 className="font-display text-6xl md:text-7xl lg:text-8xl leading-[0.85] tracking-tight">
            <span className="block text-white">WHERE TO</span>
            <span className="block text-kh-pink mt-2">WATCH NEXT</span>
          </h1>

          <p className="text-gray-300 max-w-sm text-sm md:text-base leading-relaxed mt-2 font-sans font-light">
            Follow Kennedi Harris and FBC United through an action-packed
            season. Don't miss a moment.
          </p>
        </div>
        ...
        <div className="relative flex justify-center items-center animate-fade-in-up delay-200 mt-12 lg:mt-0">
          <div className="relative z-10">
            <img
              src={scheduleHeroPlayer}
              alt="Kennedi Harris Schedule"
