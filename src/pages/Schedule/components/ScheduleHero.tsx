          ...
          <div className="relative border border-white/10 bg-neutral-900/30 backdrop-blur-md p-6 w-full max-w-[370px] min-h-[450px] flex flex-col justify-between overflow-hidden shadow-[0_30px_60px_-15px_rgba(0,0,0,0.8)] group rounded-2xl">
            ...
            <div className="my-auto py-6 text-left space-y-4">
              ...
              <div className="space-y-1">
                ...
                <h3 className="font-display text-4xl font-black text-white leading-none uppercase tracking-tighter m-0">
                  AAU TOURNAMENT
                </h3>
              </div>

              <div className="pt-2 flex items-center gap-3">
                <div className="w-8 h-8 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-sm font-black text-kh-pink">
                  VS
                </div>
                <div>
                  ...
                  <span className="font-condensed font-bold text-base text-zinc-100 uppercase tracking-wide">
                    TEAM ELITE
                  </span>
                </div>
              </div>
            ...
            <div className="border-t border-white/10 border-dashed pt-6 flex flex-col gap-4">
              ...
              <div className="w-full h-5 flex gap-[2px] opacity-20 group-hover:opacity-35 transition-opacity mt-1 select-none pointer-events-none">
                {[
                  1, 3, 1, 4, 2, 1, 3, 2, 1, 4, 1, 2, 3, 1, 2, 4, 1, 3, 2, 1, 4,
                  1, 2, 3,
                ].map((w, i) => (
                  <div
                    key={i}
