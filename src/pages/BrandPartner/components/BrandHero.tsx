      ...
      <div className="container mx-auto px-6 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col gap-6 animate-fade-in-up">
          ...
          <h1 className="font-display text-5xl md:text-6xl lg:text-7xl leading-[0.85] tracking-tight">
            <span className="block text-white">STRONG PARTNERS.</span>
            <span className="block text-kh-pink mt-2">STRONGER TOGETHER.</span>
          </h1>

          <p className="text-gray-300 max-w-md text-sm md:text-base leading-relaxed mt-2 font-sans font-light">
            Behind every great athlete is a team of champions. Thank you to the
            brands, organizations, and partners who believe in my journey and
            help me continue pushing forward on and off the court.
          </p>

          <div className="mt-4">
            <button className="btn-outline border-kh-pink text-kh-pink hover:text-white group flex items-center">
              PARTNER WITH KENNEDI
        ...
        <div className="relative flex justify-center items-center animate-fade-in-up delay-200 mt-12 lg:mt-0">
          <div className="relative z-10">
            <img
              src={heroPlayer}
              alt="Kennedi Harris Brand Partners"
